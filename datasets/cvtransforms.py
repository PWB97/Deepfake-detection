...
import time
from datasets import libjpeg_path
from turbojpeg import TurboJPEG
# from datasets.dct_resize.block_composition import block_composition

import datasets.cvfunctional as F
# from datasets.dct_resize.resize_dct_opencv import resize_dct
from dct import subset_channel_index_square, subset_channel_index_learned, subset_channel_index_triangle

__all__ = ["DCTFlatten2D", "ToYCrCb", "ChromaSubsample", "TransformDCT", "UpsampleDCT", "UpsampleCbCrDCT",
           "UpsampleCbCrDCT", "CenterCropDCT", "ToTensorDCT", "NormalizeDCT", "Upscale", "Average",
           "ResizedTransformDCT", "AdjustDCT", "DCTCenterCrop", "SubsetDCT", "SubsetDCT2", "Compose", "ToTensor",
           "ToCVImage", "UpsampleDCTOld", "Aggregate", "Aggregate2", "RandomResizedCropDCT", "Normalize", "Resize",
           "CenterCrop", "Pad", "Lambda", "RandomApply", "RandomOrder", "RandomChoice", "RandomCrop",
           "RandomHorizontalFlip", "RandomVerticalFlip", "RandomResizedCrop", "FiveCrop", "TenCrop",
           "LinearTransformation", "ColorJitter", "RandomRotation", "RandomAffine", "RandomAffine6",
           "RandomPerspective", "Grayscale", "RandomGrayscale", "RandomGaussianNoise", "RandomPoissonNoise",
           "RandomSPNoise"]
...
class ToYCrCb(object):
    def __call__(self, img):
        return F.to_ycrcb(img)

class ChromaSubsample(object):
    def __call__(self, img):
        return F.chroma_subsample(img)
